...
export default function Map() {
  ...
  useEffect(() => {
    ...
    async function initMap() {
      if (!mapRef.current) {
        console.warn("mapRef.current is null, skipping...");
        return;
      }
      ...
      // Check if effect is being unmounted
      if (abortController.signal.aborted) {
        console.warn("Effect was aborted, skipping initialization...");
        return;
      }
      ...
      if (abortController.signal.aborted || !mapRef.current) {
        console.warn("Effect was aborted or mapRef is null after import, skipping...");
        return;
      }
    ...
    return () => {
      // Signal the async operation to stop
      ...
      // Clean up Leaflet's internal references from the DOM
      if (mapRef.current) {
        delete (mapRef.current as any)._leaflet_id;
      }
    };
